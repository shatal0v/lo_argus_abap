*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVHR_ARGUS_DATES
*   generation date: 01.12.2020 at 00:12:12
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVHR_ARGUS_DATES    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVHR_ARGUS_DATES'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVHR_ARGUS_DATES_EXTRACT
TOTAL = ZVHR_ARGUS_DATES_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVHR_ARGUS_DATES'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVHR_ARGUS_DATES-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_ARGUS_DATES_EXTRACT
TOTAL = ZVHR_ARGUS_DATES_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVHR_ARGUS_DATES-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVHR_ARGUS_DATES'
...
TOTAL = ZVHR_ARGUS_DATES_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVHR_ARGUS_DATES-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVHR_ARGUS_DATES-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVHR_ARGUS_DATES'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVHR_ARGUS_DATES-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVHR_ARGUS_DATES_EXTRACT
TOTAL = ZVHR_ARGUS_DATES_TOTAL
